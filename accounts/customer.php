      ...
      <div class="row">
        ...
        <div class="col-lg-12">
		 <ul class="nav nav-tabs" role="tablist">
			...
			<li class="nav-item">
			  <a href="customer.php" class="nav-link active" data-toggle="tab" href="#home" >Customers</a>
			</li>
			<li class="nav-item">
			<a href="customer-record.php" class="nav-link " data-toggle="tab" href="#menu1" >Customers Behavior</a>
			</li>
